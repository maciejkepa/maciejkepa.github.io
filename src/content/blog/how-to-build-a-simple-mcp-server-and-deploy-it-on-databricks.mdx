...
<figure class="article-figure article-cover-figure">
  <img
    src="/blog-covers/how-to-build-a-simple-mcp-server-and-deploy-it-on-databricks-1600.webp"
    alt="Hand-drawn sketch of a custom MCP server on Databricks Apps connected to an agent client, GTD tools, SQLite, Delta storage and a SQL warehouse"
    width="1537"
    height="1023"
    loading="eager"
    decoding="async"
