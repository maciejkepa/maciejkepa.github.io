...
<figure class="article-figure article-cover-figure">
  <img
    src="/blog-covers/medallion-architecture-for-engineers-1600.webp"
    alt="Hand-drawn technical sketch of source events moving through raw system-of-record data, trusted data, quarantine and published data products"
    width="1600"
    height="900"
    loading="eager"
    decoding="async"
