...
<figure class="article-figure article-cover-figure">
  <img
    src="/blog-covers/mlops-engineering-not-tooling-1600.webp"
    alt="Hand-drawn systems sketch showing MLOps as connected engineering work across code, data, deployment and monitoring"
    width="1586"
    height="992"
    loading="eager"
    decoding="async"
